...
The mean shadow area is defined for any Borel set; see \ref{prop:def}.
...
Assuming that $K$ is a counterexample, we will find a point $p\in \cont K$ and chop $K$ in a small neighborhood of $p$ producing a worse counterexample.
...
In fact the second part of the lemma (with $\eps<0$) holds if $K$ is not a ball;
